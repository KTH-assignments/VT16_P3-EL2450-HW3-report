...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/1.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/1.magnified.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/2.tex}}
      \caption{The orientation of the robot over time for
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/2.magnified.tex}}
      \caption{The steady state orientation of the robot for
        $K_{\omega}^T = 0.2 K_{\omega, max}^T$}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/3.tex}}
      \caption{The orientation of the robot over time for
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/3.magnified.tex}}
      \caption{The steady state orientation of the robot for
        $K_{\omega}^T = 0.5 K_{\omega, max}^T$}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/4.tex}}
      \caption{The orientation of the robot over time for
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/4.magnified.tex}}
      \caption{The steady state orientation of the robot for
        $K_{\omega}^T = 0.75 K_{\omega, max}^T$}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/5.tex}}
      \caption{The orientation of the robot over time for
        $K_{\omega}^T = K_{\omega, max}^T$.}
      \label{fig:13_max}
    \end{figure}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/5.magnified.tex}}
      \caption{The steady state orientation of the robot for
        $K_{\omega}^T = K_{\omega, max}^T$}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_13/6.tex}}
      \caption{The orientation of the robot over time for
        $K_{\omega}^T = 1.1 K_{\omega, max}^T$. The system is marginally stable}
