...
\begin{figure}[H]\centering
  \scalebox{0.7}{\input{./figures/task_22/map_7_3d_xyt.tex}}
...
\begin{minipage}{\linewidth}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_dist01_2_1.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_dist02_1_5.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_dist03_5_3.tex}}
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_angle.tex}}
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_angle01_2_1.tex}}
      \caption{The robot travels from node 2 to node 1. Its steady-state
...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_angle02_1_5.tex}}
      \caption{The robot travels from node 1 to node 5. Its steady-state
  ...
  \begin{minipage}{0.45\linewidth}
    \begin{figure}[H]
      \scalebox{0.6}{\input{./figures/task_22/e_angle03_5_3.tex}}
      \caption{The robot travels from node 5 to node 3. Its steady-state
